...
class sem_kitti_cfg:
    def __init__(self):
        ...
        self.parser.add_argument('--kitti_root', 
                                type=str,
                                default='/mnt/cfs/algorithm/public_data/odometry/kitti_odometry_color')
        self.parser.add_argument('--kitti_preprocess_root', 
                                type=str,
                                default='/mnt/cfs/algorithm/public_data/odometry/semantic_kitti_voxel_label')
...
# python semantic_kitti_preprocess.py