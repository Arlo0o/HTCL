...
def custom_single_gpu_test(model, data_loader, show=False, out_dir=None, 
    ...
    for i, data in enumerate(data_loader):
        # if i<3000 :
            ...
            # if filename=="000105" or filename=="000080" or filename=="000315" or filename=="000925":
            ...
            mmcv.dump(outputs, "/code/occupancy-lss/occupancy-lss-0603/work_dirs/save_1713/"+ filename + ".pkl")
