...
class SwinUNETR(nn.Module):
    ...
    def forward(self, x_in):
        ...
        # logits = self.out(out)
        # print( hidden_states_out[0].shape, enc0.shape, enc1.shape, enc2.shape, enc3.shape, dec4.shape )
        ##torch.Size([1, 48, 64, 64, 16]) torch.Size([1, 48, 128, 128, 32]) torch.Size([1, 48, 64, 64, 16]) torch.Size([1, 96, 32, 32, 8]) torch.Size([1, 192, 16, 16, 4]) torch.Size([1, 768, 4, 4, 1])
        return logits
...
class SwinUNETR_Iinit(nn.Module):
    """
    Swin UNETR based on: "Hatamizadeh et al.,
    Swin UNETR: Swin Transformers for Semantic Segmentation of Brain Tumors in MRI Images
    <https://arxiv.org/abs/2201.01266>"
...
class SwinTransformer_Init(nn.Module):
    """
    Swin Transformer based on: "Liu et al.,
    Swin Transformer: Hierarchical Vision Transformer using Shifted Windows
    <https://arxiv.org/abs/2103.14030>"
